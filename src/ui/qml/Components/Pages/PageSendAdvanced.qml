    ...
    ColumnLayout {
        ...
        ColumnLayout {
            ...
            ComboBox {
                ...
                property string filterString: ""//filterPopupWallets.filterText // alias
            ...
            ComboBox {
                ...
                property var checkedElementsText: []
                property int numberOfCheckedElements: checkedElements.length
                property string filterString: ""//filterPopupAddresses.filterText // alias
            ...
            ComboBox {
                ...
                property var checkedElementsText: []
                property int numberOfCheckedElements: checkedElements.length
                property string filterString: "" //filterPopupOutputs.filterText // alias
        ...
        ColumnLayout {
            ...
            ListView {
                ...
                delegate: Item {}/*DestinationListDelegate {
